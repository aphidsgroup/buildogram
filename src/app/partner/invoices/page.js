  ...
  return (
    <div>
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ color: 'var(--text-muted)' }}>Upload bills, manage petty cash, and track site-wise expenses.</p>
      </div>
      ...
      <div className="card" style={{ padding: '60px 20px', textAlign: 'center', borderRadius: '16px', background: '#fff', border: '1px solid var(--border)' }}>
        ...
        <p style={{ color: 'var(--text-muted)', maxWidth: '500px', margin: '0 auto 24px', lineHeight: 1.6 }}>
          You haven't added any records to the Invoice Manager module yet. Start by creating your first entry to populate this dashboard.
        </p>
