...
export const metadata = generateSEOMetadata({
  title: 'Construction Quality Inspection in Chennai | Buildogram',
  description: 'Get independent construction quality inspections in Chennai. Ensure your builder follows structural and material specifications correctly.',
  path: '/quality-inspection-chennai',
});
...
export default function Page() {
  return ( <>
    <main className="page" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
      <div className="sectionInner">
        ...
        <div style={{ marginBottom: '16px', fontSize: '14px', color: '#64748B' }}>
          <a href="/" style={{ color: '#FC6E20' }}>Home</a> / <span style={{ color: '#0F172A', fontWeight: 600 }}>Construction Quality Inspection in Chennai</span>
        </div>

        <h1 style={{ fontSize: '36px', fontWeight: 800, color: '#0F172A', marginBottom: '24px' }}>
          Construction Quality Inspection in Chennai
        </h1>

        <AnswerBlock 
          question="Why use Buildogram for your project?" 
          answer="Get independent construction quality inspections in Chennai. Ensure your builder follows structural and material specifications correctly." 
        />

        <ProcessSteps 
          title="Our Approach to Construction Quality Inspection in Chennai"
          steps={[
        ...
        <EntitySummary serviceName="Construction Quality Inspection in Chennai" />
    ...
    <BreadcrumbSchema items={[{"name":"Home","path":"/"},{"name":"Construction Quality Inspection in Chennai","path":"/quality-inspection-chennai"}]} />
    </>
  );
}
