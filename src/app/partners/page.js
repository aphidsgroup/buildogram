...
export const metadata = generateSEOMetadata({
  ...
  description: 'Browse builders, architects, contractors and material suppliers listed in Buildogram\'s Chennai partner directory. Independently review credentials before appointment.',
  path: '/partners',
});
      ...
      <section id="join" className="section" style={{ background: '#F9F9F9' }}>
        <div className="container" style={{ maxWidth: '640px' }}>
          <div style={{ textAlign: 'center', marginBottom: '40px' }}>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '17px' }}>Apply for a reviewed directory profile and relevant project enquiries.</p>
          </div>
