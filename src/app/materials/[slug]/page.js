  ...
  return (
    <>
      ...
      <section style={{ background: 'var(--secondary)', color: 'white', padding: '60px 0 72px' }}>
        <div className="container">
          <nav style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '20px', fontSize: '13px' }}>
            ...
            <span style={{ color: '#FFDA01' }}>{mat.name}</span>
          </nav>
      ...
      <div className="container" style={{ padding: '56px 24px' }}>
        ...
        {/* RATE NOTE */}
        {mat.rateNote && (
          <div style={{ background: 'rgba(255,218,1,0.06)', border: '1px solid rgba(255,218,1,0.2)', borderRadius: '12px', padding: '20px 24px', marginBottom: '40px' }}>
