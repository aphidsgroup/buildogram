...
export default function Page() {
  return ( <>
    <PublicServicePage
      ...
      processSteps={[{"step":"01","title":"Plot & Requirement Analysis","desc":"We map out your plot size, FSI, and lifestyle needs."},{"step":"02","title":"Partner Selection","desc":"We help you shortlist builders based on actual past projects."},{"step":"03","title":"Execution & Tracking","desc":"Site OS tracks every milestone, material delivery, and quality check."}]}
