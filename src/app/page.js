...
export default function Home() {
  return (
    <div className={styles.page}>
        ...
        <div className={`container ${styles.heroContent} ${styles.mobileCenter}`}>
          <div>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'rgba(255,218,1,0.1)', border: '1px solid rgba(255,218,1,0.25)', borderRadius: '999px', padding: '8px 20px', marginBottom: '32px' }}>
              ...
              <span style={{ color: '#FFDA01', fontSize: '13px', fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase' }}>Buildogram</span>
            </div>
            ...
            <h1 style={{ color: 'white', fontSize: 'clamp(38px, 5vw, 64px)', lineHeight: 1.05, marginBottom: '20px', fontFamily: 'Space Grotesk, sans-serif', fontWeight: 800 }}>
              The Construction &<br />
              <span style={{ color: '#FFDA01' }}>Property Marketplace</span>
            </h1>
      ...
      <section className="section" style={{ background: 'var(--secondary)', color: 'white' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '56px' }}>
            <span className="tag" style={{ background: 'rgba(255,218,1,0.12)', color: '#FFDA01', border: '1px solid rgba(255,218,1,0.2)' }}>Marketplace Support</span>
          ...
          <div className="grid-3" style={{ gap: '24px' }}>
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px' }}>
              ...
              <Link href="/property-passport" style={{ display: 'inline-block', marginTop: '20px', color: '#FFDA01', fontWeight: 600, textDecoration: 'none' }}>Learn more →</Link>
            </div>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px' }}>
              ...
              <Link href="/boq-audit" style={{ display: 'inline-block', marginTop: '20px', color: '#FFDA01', fontWeight: 600, textDecoration: 'none' }}>Learn more →</Link>
            </div>
            ...
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '16px', padding: '32px' }}>
              ...
              <Link href="/maintenance" style={{ display: 'inline-block', marginTop: '20px', color: '#FFDA01', fontWeight: 600, textDecoration: 'none' }}>Learn more →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ══════════════════ FINAL CTA ══════════════════ */}
      <section className="section" style={{ background: '#FFDA01', color: '#1A1A1A', textAlign: 'center' }}>
        <div className="container">
