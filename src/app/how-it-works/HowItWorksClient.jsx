    ...
    <>
      ...
      <div className="container" style={{ padding: '56px 24px' }}>
        ...
        <div className="card text-center mb-8" style={{ padding: '40px', background: 'var(--gradient-dark)', color: 'white', border: 'none' }}>
          ...
          <p className="text-muted mb-6" style={{ color: 'rgba(255,255,255,0.7)', maxWidth: '600px', margin: '12px auto' }}>
          ...
          <div className="flex-center gap-4">
            ...
            <Link href="/cost-estimator" className="btn btn-outline" style={{ color: 'white', borderColor: 'white' }}>Calculate My Cost</Link>
          </div>
        </div>
      </div>
    </>
