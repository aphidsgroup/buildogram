        ...
        <div className={`sectionInner ${styles.formWrap}`}>
          ...
          <AnimatedSection delay={0.3}>
            <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.5)', fontSize: '15px', marginTop: '24px' }}>
              Or call us directly: <a href="tel:+919360232456" style={{ color: 'rgba(255,255,255,0.8)', fontWeight: 'bold', display: 'inline-block', padding: '12px 8px', margin: '-12px -8px' }}>+91 93602 32456</a>
            </p>
