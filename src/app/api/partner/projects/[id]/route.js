...
export async function GET(request, { params }) {
  ...
  try {
    ...
    const [row] = await sql`SELECT * FROM partner_projects WHERE id = ${(await params).id} AND partner_id = ${u.partner_id} LIMIT 1`;
