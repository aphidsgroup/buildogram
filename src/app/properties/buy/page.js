...
export default async function PropertiesBuyPage() {
  let listings = [];
  try {
    listings = await sql`
      ...
      WHERE lead_type = 'property_listing'
        ...
        AND metadata->>'listing_type' IN ('resale', 'buy')
        ...
        <div className="container">
          {listings.length === 0 ? (
            <div className="card text-center" style={{ padding: '60px' }}>
              ...
              <h2 style={{ fontSize: '20px', marginBottom: '8px' }}>No Resales Available</h2>
              <p className="text-muted">All our published resale properties have been sold. Check back soon!</p>
            </div>
          ) : (
                ...
                >
                  ...
                  <div style={{ height: '220px', background: '#1e293b', position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <div style={{ position: 'absolute', bottom: '16px', left: '16px' }}>
                      <div style={{ color: 'rgba(255,255,255,0.8)', fontSize: '12px', fontWeight: 600, textTransform: 'uppercase', marginBottom: '2px' }}>Asking Price</div>
