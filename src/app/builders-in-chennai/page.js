...
export const metadata = generateSEOMetadata({
  ...
  description: 'Find and compare builders in Chennai with Buildogram. Review contractor quotes, check BOQs, compare materials, and plan construction with engineer-led support.',
  path: '/builders-in-chennai',
});
...
export default function Page() {
  return ( <>
    <main className="page" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
      <div className="sectionInner">
        ...
        <div style={{ marginBottom: '16px', fontSize: '14px', color: '#64748B' }}>
          <a href="/" style={{ color: '#FC6E20' }}>Home</a> / <span style={{ color: '#0F172A', fontWeight: 600 }}>Verified Builders in Chennai</span>
        </div>

        <h1 style={{ fontSize: '36px', fontWeight: 800, color: '#0F172A', marginBottom: '24px' }}>
          Verified Builders in Chennai
        </h1>

        <AnswerBlock 
          question="Why use Buildogram for your project?" 
          answer="Find and compare builders in Chennai with Buildogram. Review contractor quotes, check BOQs, compare materials, and plan construction with engineer-led support." 
        />

        <ProcessSteps 
          title="Our Approach to Verified Builders in Chennai"
          steps={[
        ...
        <EntitySummary serviceName="Verified Builders in Chennai" />
    ...
    <BreadcrumbSchema items={[{"name":"Home","path":"/"},{"name":"Builders in Chennai","path":"/builders-in-chennai"}]} />
    </>
  );
}
