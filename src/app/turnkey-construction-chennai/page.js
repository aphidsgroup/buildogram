...
export const metadata = generateSEOMetadata({
  title: 'Turnkey Construction in Chennai | Verified Turnkey Contractors | Buildogram',
  description: 'Find verified turnkey construction contractors in Chennai. We audit your BOQ, ensure material quality, and track milestone completion.',
    ...
    <main className="page" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
      <div className="sectionInner">
        ...
        <div style={{ marginBottom: '16px', fontSize: '14px', color: '#64748B' }}>
          <a href="/" style={{ color: '#FC6E20' }}>Home</a> / <span style={{ color: '#0F172A', fontWeight: 600 }}>Turnkey Construction in Chennai</span>
        </div>

        <h1 style={{ fontSize: '36px', fontWeight: 800, color: '#0F172A', marginBottom: '24px' }}>
          Turnkey Construction in Chennai
        </h1>

        <AnswerBlock 
          question="Why use Buildogram for your project?" 
          answer="Find verified turnkey construction contractors in Chennai. We audit your BOQ, ensure material quality, and track milestone completion." 
        />

        <ProcessSteps 
          title="Our Approach to Turnkey Construction in Chennai"
          steps={[
        ...
        <EntitySummary serviceName="Turnkey Construction in Chennai" />
