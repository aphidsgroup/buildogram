...
export const metadata = generateSEOMetadata({
  title: 'Construction & Property Services in Chennai | Buildogram',
  description: 'Buildogram provides engineer-led construction, structural audits, BOQ review, material sourcing, and soil testing across Chennai.',
      ...
      <section style={{ background: 'var(--secondary)', color: 'white', padding: '60px 0 72px' }}>
        <div className="container">
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'linear-gradient(135deg, rgba(255, 163, 100, 0.18), rgba(252, 110, 32, 0.14))', border: '1px solid rgba(252, 110, 32, 0.28)', borderRadius: '999px', padding: '6px 18px', marginBottom: '20px' }}>
            <span style={{ background: 'var(--gradient-orange-strong)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', color: 'transparent', fontSize: '12px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>📍 Service Area Hub</span>
          </div>
          ...
          <p style={{ color: 'rgba(255,255,255,0.7)', fontSize: '17px', maxWidth: '580px', lineHeight: 1.7 }}>
            Buildogram serves Chennai with AI-driven, engineer-led construction services, BOQ reviews, structural audits, and verified partners.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: '60px 0', background: 'white' }}>
        <div className="container">
          ...
          <div className="grid-3" style={{ gap: '20px' }}>
            <Link href="/services/house-construction" style={{ textDecoration: 'none' }}>
