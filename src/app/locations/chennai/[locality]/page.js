      ...
      <section style={{ background: 'var(--secondary)', color: 'white', padding: '60px 0 72px' }}>
        <div className="container">
          <nav style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '20px', fontSize: '13px' }}>
            ...
            <span style={{ color: '#FFDA01' }}>{loc.name}</span>
          </nav>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: 'rgba(255,218,1,0.1)', borderRadius: '6px', padding: '4px 12px', marginBottom: '16px', fontSize: '12px', color: '#FFDA01', fontWeight: 700 }}>
            📍 {loc.region}
          </div>
