...
export const metadata = generateSEOMetadata({
  title: 'Renovation Contractors in Chennai | Verified Home Remodeling | Buildogram',
  description: 'Connect with verified renovation contractors in Chennai. We review your remodeling BOQ to prevent hidden costs and ensure quality execution.',
    ...
    <main className="page" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
      <div className="sectionInner">
        ...
        <div style={{ marginBottom: '16px', fontSize: '14px', color: '#64748B' }}>
          <a href="/" style={{ color: '#FC6E20' }}>Home</a> / <span style={{ color: '#0F172A', fontWeight: 600 }}>Renovation Contractors in Chennai</span>
        </div>
        ...
        <AnswerBlock 
          ...
          answer="Connect with verified renovation contractors in Chennai. We review your remodeling BOQ to prevent hidden costs and ensure quality execution." 
        />

        <ProcessSteps 
          title="Our Approach to Renovation Contractors in Chennai"
          steps={[
        ...
        <EntitySummary serviceName="Renovation Contractors in Chennai" />
