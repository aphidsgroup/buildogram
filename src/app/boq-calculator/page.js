...
<div class="hdr">
  ...
  <div class="rpt"><h1>BILL OF QUANTITIES</h1><p>Indicative estimate \u2014 rate assumptions derived from the COCENA Issue 35 (Dec 2025) schedule referenced by this calculator. Not an official schedule of rates.</p><p>Generated: ${new Date().toLocaleDateString('en-IN',{day:'2-digit',month:'short',year:'numeric'})}</p></div>
</div>
<div class="proj">
...
<div class="ftr"><p><strong>Disclaimer:</strong> Rate assumptions are derived from the COCENA Issue 35 (December 2025) schedule referenced by this calculator. This is an indicative estimate, not an official schedule of rates, and it does not replace a project-specific BOQ. Actual costs may vary \u00B115% depending on site conditions, material grades, labour availability, and contractor. This BOQ is indicative only and not a binding quotation. For a professional verified estimate, contact Buildogram at <strong>+91 95661 11222</strong> or <strong>info@buildogram.in</strong>.</p></div>
<div class="wm">Generated by Buildogram BOQ Calculator \u00B7 www.buildogram.in \u00B7 Indicative estimate \u2014 not an official schedule of rates</div>
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #0F172A 0%, #1E293B 50%, #0F172A 100%)', padding: '0 0 60px' }}>
      ...
      <div style={{ textAlign: 'center', padding: '48px 24px 32px', color: 'white' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 8, background: 'rgba(252,110,32,0.15)', border: '1px solid rgba(252,110,32,0.3)', borderRadius: 100, padding: '6px 16px', marginBottom: 20 }}>
          <span style={{ fontSize: 12, fontWeight: 700, color: '#FC6E20', textTransform: 'uppercase', letterSpacing: 1 }}>🧮 Free Tool · Indicative Estimate</span>
        </div>
      ...
      <div style={{ maxWidth: 860, margin: '0 auto', padding: '0 16px' }}>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', minWidth: 860 }}>
                  <thead>
                    <tr style={{ background: '#0F172A' }}>
                      ...
                      <th style={{ padding: '9px 10px', fontSize: 11, fontWeight: 700, textAlign: 'right', color: '#FCD34D', whiteSpace: 'nowrap', background: '#1E293B' }}>Reference rate</th>
        ...
        <p style={{ textAlign: 'center', fontSize: 12, color: '#475569', marginTop: 24, lineHeight: 1.6 }}>
          ℹ️ <strong>Indicative estimate only.</strong> Rate assumptions are derived from the COCENA Issue 35 (Dec 2025) schedule of rates for Chennai and are editable in this tool. This is not an official schedule of rates, and it does not replace a project-specific BOQ or a professional estimate. Actual quotations vary with specification, locality, supplier, labour, GST and transport. 
