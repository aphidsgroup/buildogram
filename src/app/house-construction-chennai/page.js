...
export const metadata = generateSEOMetadata({
  title: 'House Construction in Chennai | Engineer-Led Process | Buildogram',
  description: 'Build your house in Chennai with complete transparency. We help you review plans, check contractor quotes, and track construction progress.',
  path: '/house-construction-chennai',
});
...
export default function Page() {
  return ( <>
    <main className="page" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
      <div className="sectionInner">
        ...
        <div style={{ marginBottom: '16px', fontSize: '14px', color: '#64748B' }}>
          <a href="/" style={{ color: '#FC6E20' }}>Home</a> / <span style={{ color: '#0F172A', fontWeight: 600 }}>House Construction in Chennai</span>
        </div>
        ...
        <AnswerBlock 
          ...
          answer="Build your house in Chennai with complete transparency. We help you review plans, check contractor quotes, and track construction progress." 
        />

        <ProcessSteps 
          title="Our Approach to House Construction in Chennai"
          steps={[
        ...
        <EntitySummary serviceName="House Construction in Chennai" />
    ...
    <BreadcrumbSchema items={[{"name":"Home","path":"/"},{"name":"House Construction in Chennai","path":"/house-construction-chennai"}]} />
    </>
  );
}
