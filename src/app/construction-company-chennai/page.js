...
export const metadata = generateSEOMetadata({
  ...
  description: 'Looking for a construction company in Chennai? Buildogram helps you compare builders, review BOQs, verify quotes, source materials, and manage your project.',
  path: '/construction-company-chennai',
});
...
export default function Page() {
  return ( <>
    <main className="page" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
      <div className="sectionInner">
        ...
        <div style={{ marginBottom: '16px', fontSize: '14px', color: '#64748B' }}>
          <a href="/" style={{ color: '#FC6E20' }}>Home</a> / <span style={{ color: '#0F172A', fontWeight: 600 }}>Construction Company in Chennai</span>
        </div>
        ...
        <AnswerBlock 
          ...
          answer="Looking for a construction company in Chennai? Buildogram helps you compare builders, review BOQs, verify quotes, source materials, and manage your project." 
        />

        <ProcessSteps 
          title="Our Approach to Construction Company in Chennai"
          steps={[
        ...
        <EntitySummary serviceName="Construction Company in Chennai" />
    ...
    <BreadcrumbSchema items={[{"name":"Home","path":"/"},{"name":"Construction Company in Chennai","path":"/construction-company-chennai"}]} />
    </>
  );
}
