...
export const metadata = generateSEOMetadata({
  title: 'Residential Construction in Chennai | House Building Support | Buildogram',
  description: 'Expert residential construction support in Chennai. Get engineer-led BOQ audits, find verified contractors, and manage site progress digitally.',
    ...
    <main className="page" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
      <div className="sectionInner">
        ...
        <div style={{ marginBottom: '16px', fontSize: '14px', color: '#64748B' }}>
          <a href="/" style={{ color: '#FC6E20' }}>Home</a> / <span style={{ color: '#0F172A', fontWeight: 600 }}>Residential Construction in Chennai</span>
        </div>

        <h1 style={{ fontSize: '36px', fontWeight: 800, color: '#0F172A', marginBottom: '24px' }}>
          Residential Construction in Chennai
        </h1>

        <AnswerBlock 
          question="Why use Buildogram for your project?" 
          answer="Expert residential construction support in Chennai. Get engineer-led BOQ audits, find verified contractors, and manage site progress digitally." 
        />

        <ProcessSteps 
          title="Our Approach to Residential Construction in Chennai"
          steps={[
        ...
        <EntitySummary serviceName="Residential Construction in Chennai" />
