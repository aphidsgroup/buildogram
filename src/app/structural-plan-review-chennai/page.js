...
const faqSchema = generateFAQSchema([
  ...
  { question: 'Who actually conducts the review?', answer: 'Reviews are coordinated with structural engineering professionals based on the project scope and availability. Ask for the assigned reviewer\'s qualifications and applicable registration details before engagement.' },
...
const faqs = [
  ...
  { q: 'Who actually conducts the review?', a: 'Reviews are coordinated with structural engineering professionals based on the project scope and availability. Ask for the assigned reviewer\'s qualifications and applicable registration details before engagement.' },
      ...
      <div className="container" style={{ maxWidth: '900px', padding: '60px 24px' }}>
        ...
        <section style={{ marginBottom: '56px' }}>
          ...
          <p style={{ color: 'var(--text)', lineHeight: 1.8, fontSize: '16px', marginBottom: '16px' }}>
            Structural drawings may look complete — column layout, beam sections, and rebar details — while still lacking documented engineering calculations. Independent review helps identify sizes or spacings that need clarification against the project&apos;s actual loads and site conditions.
          </p>
          <p style={{ color: 'var(--text)', lineHeight: 1.8, fontSize: '16px', marginBottom: '16px' }}>
