...
export const metadata = generateSEOMetadata({
  title: 'Home Construction in Chennai | Engineer-Led House Building Support | Buildogram',
  description: 'Buildogram helps Chennai homeowners plan, verify, and manage home construction with BOQ reviews, contractor quote checks, material sourcing, and engineer-led guidance.',
    ...
    <main className="page" style={{ paddingTop: '80px', paddingBottom: '80px' }}>
      <div className="sectionInner">
        ...
        <div style={{ marginBottom: '16px', fontSize: '14px', color: '#64748B' }}>
          <a href="/" style={{ color: '#FC6E20' }}>Home</a> / <span style={{ color: '#0F172A', fontWeight: 600 }}>Home Construction in Chennai</span>
        </div>
        ...
        <AnswerBlock 
          ...
          answer="Buildogram helps Chennai homeowners plan, verify, and manage home construction with BOQ reviews, contractor quote checks, material sourcing, and engineer-led guidance." 
        />

        <ProcessSteps 
          title="Our Approach to Home Construction in Chennai"
          steps={[
        ...
        <EntitySummary serviceName="Home Construction in Chennai" />
