  ...
  return (
    <aside style={{ padding: '24px', background: '#F1F5F9', borderRadius: '12px', margin: '32px 0' }}>
      ...
      <p style={{ margin: '0 0 16px 0', fontSize: '15px', lineHeight: 1.6, color: '#0F172A' }}>
        Buildogram is an engineer-led construction companion for Chennai. We help property owners review BOQs, source verified materials, manage site progress, and connect with trusted <Link href="/builders-in-chennai" style={{ color: '#FC6E20', fontWeight: 600 }}>builders in our network</Link>.
      </p>
