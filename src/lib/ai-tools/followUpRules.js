/**
 * Rules Engine for AI Tool Submissions
 * Evaluates the tool name and output data to determine follow-up priority, risk level,
 * recommended ops team, and suggested scripts.
 */

export function evaluateFollowUpRules(toolName, outputData) {
  // Default base
  let result = {
    risk_level: 'medium',
    score: 50,
