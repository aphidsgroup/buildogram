export const SERVICES = [
  ...
  },
  {
    ...
    metaDescription: "End-to-end construction coordinated by Buildogram and executed by verified partners in Chennai. Design, BOQ verification, material sourcing, stage-wise quality supervision and handover.",
    h1: "End-to-End Construction in Chennai \u2014 Coordinated by Buildogram, Executed by Verified Partners",
    heroSubtitle: '',
  ...
  },
  {
    ...
    metaDescription: "Get your building inspected by qualified structural engineers in Chennai. We conduct thorough structural audits using Non-Destructive Testing (NDT) to check for cracks, corrosion, and safety.",
  ...
  },
  {
    ...
    metaDescription: "Qualified engineers for building crack inspection in Chennai. We analyze wall and column cracks, identify the root cause (settlement, thermal, corrosion), and provide repair solutions.",
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Do I need police permission to fly?", answer: "Drone flights in certain \"Red Zones\" in Chennai (near the airport, military bases, or port) are strictly restricted. The drone operators we coordinate with manage Digital Sky portal clearances before flying." },
    ],
    stats: [],
    ctaHref: "/contact?type=survey",
  ...
  },
  {
    ...
    metaDescription: "Expert NDT testing for buildings and concrete structures in Chennai. Rebound hammer, UPV, rebar scanning, core extraction and half-cell potential testing by qualified engineers.",
