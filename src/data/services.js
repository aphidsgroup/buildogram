export const SERVICES = [
  {
    ...
    steps: [
      ...
      { step: "03", title: "Itemised BOQ & Scope Agreement", desc: "We generate an itemised Bill of Quantities specifying every bag of cement, every metre of TMT steel and every pipe fitting. Rates are benchmarked against Chennai market prices and agreed before work begins \u2014 giving you cost visibility and a documented basis for any variation approvals." },
      ...
      { step: "05", title: "Quality Handover", desc: "We conduct 48-hour waterproofing pond tests, electrical insulation checks, and plumbing pressure tests before handing over keys \u2014 along with all lab receipts, as-built drawings, and the execution partner\u2019s warranty documentation." },
    ],
    faqs: [
      { question: "Do you directly build homes or manage contractors?", answer: "Buildogram is an engineer-led support platform. We review BOQs, verify materials, provide site supervision, and connect you with contractors in our network \u2014 but the construction contract is between you and the builder." },
      ...
      { question: "What is a capped BOQ contract?", answer: "A capped BOQ contract locks the scope and rates at signing based on an itemised Bill of Quantities. Unlike a per-sqft contract, every material is specified by brand, grade, and quantity. Buildogram reduces cost uncertainty through scope verification, quotation comparison and documented variation tracking. Contractor-caused errors or material waste are a contractor liability. However, final project cost may change due to client-approved design changes, unforeseen site conditions, statutory requirements or material-price movements \u2014 all of which are documented before any additional spend is authorised." },
    ...
    relatedLinks: [["End-to-End Construction", "/turnkey-construction-chennai"], ["Site Supervision", "/site-supervision-chennai"], ["BOQ Calculator", "/boq-calculator"], ["Soil Testing", "/soil-testing-chennai"], ["Structural Audit", "/structural-audit-chennai"]],
    jsonLdType: "construction",
    extraSections: [],
  },
  {
    slug: "house-construction-chennai",
    title: "House Construction in Chennai | Engineer Review & BOQ | Buildogram",
    metaDescription: "Planning to build a house in Chennai? Buildogram connects you with engineers in our network, reviews contractor quotes, and ensures transparent BOQ for your project.",
    h1: "House Construction in Chennai",
    heroSubtitle: '',
    heroTag: "",
    hasHero: false,
    answerQuestion: "Why use Buildogram for your project?",
    answerText: "Planning to build a house in Chennai? Buildogram connects you with engineers in our network, reviews contractor quotes, and ensures transparent BOQ for your project.",
    ...
    steps: [
      ...
      { step: "03", title: "Partner Network", desc: "We connect you with builders and contractors from our partner network, tailored to your project." },
      { step: "04", title: "Site Tracking", desc: "Monitor milestones and material deliveries via our digital platform." },
    ],
    faqs: [
      { question: "Do you provide direct construction services?", answer: "We are an engineer-led support platform. We connect you with contractors in our network and audit their work to ensure quality and transparency." },
      ...
      { question: "Can I source materials through Buildogram?", answer: "Yes, we provide transparent quotes for cement, steel, sand, and other materials directly from suppliers in our network in Chennai." },
    ],
    stats: [],
    ctaHref: "/contact?type=construction",
  ...
  },
  {
    ...
    title: "Commercial Construction in Chennai | Construction Contractors | Buildogram",
    metaDescription: "Planning a commercial building in Chennai? Buildogram offers BOQ reviews, contractors in our network, and material sourcing for commercial projects.",
    h1: "Commercial Construction in Chennai",
    heroSubtitle: '',
    heroTag: "",
    hasHero: false,
    answerQuestion: "Why use Buildogram for your project?",
    answerText: "Planning a commercial building in Chennai? Buildogram offers BOQ reviews, contractors in our network, and material sourcing for commercial projects.",
  ...
  },
  {
    ...
    title: "End-to-End Construction in Chennai | Partner-Executed, Buildogram-Coordinated | Buildogram",
    metaDescription: "End-to-end construction coordinated by Buildogram and executed by partner contractors in Chennai. Design, BOQ verification, material sourcing, stage-wise quality supervision and handover.",
    h1: "End-to-End Construction in Chennai \u2014 Coordinated by Buildogram, Executed by Partner Contractors",
    heroSubtitle: '',
    heroTag: "End-to-End Construction",
    hasHero: true,
    answerQuestion: "",
    answerText: "",
    processStepsTitle: "",
    ...
    faqs: [
      ...
      { question: "What if the project costs more than the initial BOQ?", answer: "Buildogram reduces cost uncertainty through an itemised BOQ, scope verification, quotation comparison and documented variation tracking. Contractor-caused errors or material waste are a contractor liability under the execution contract. However, final project cost may change due to client-approved design changes, unforeseen site conditions, statutory requirements or material-price movements \u2014 all of which are tracked and documented before any additional spend is authorised." },
    ],
    stats: [],
    ...
    breadcrumbLabel: "End-to-End Construction in Chennai",
    relatedLinks: [],
    jsonLdType: "construction",
    extraSections: [],
  },
  ...
  },
  {
    ...
    title: "Construction Company in Chennai | Builders & BOQ Review | Buildogram",
  ...
  },
  {
    ...
    processStepsTitle: "Our Approach to Builder Selection in Chennai",
    steps: [
      { step: "01", title: "Requirement Mapping", desc: "We map out your plot size, location, budget, and specific construction needs." },
      { step: "02", title: "Plan & BOQ Review", desc: "Our engineers audit architectural plans and contractor quotes to prevent hidden costs." },
      { step: "03", title: "Partner Network", desc: "We connect you with builders and contractors from our partner network, tailored to your project." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What areas do you cover?", answer: "We cover Chennai and all major districts in Tamil Nadu through our engineer and partner network." },
  ...
  },
  {
    ...
    metaDescription: "Independent structural audit coordination with structural engineering professionals in Chennai. We conduct thorough structural audits using Non-Destructive Testing (NDT) to check for cracks, corrosion, and safety.",
    h1: "Structural Audit Services in Chennai",
    heroSubtitle: '',
    heroTag: "",
    hasHero: false,
    answerQuestion: "",
    ...
    ctaSecondaryHref: "",
    ctaSecondaryLabel: "",
    breadcrumbLabel: "Structural Audit Services in Chennai",
    relatedLinks: [],
    jsonLdType: "audit",
    extraSections: [],
  },
  {
    ...
    metaDescription: "Buildogram provides engineer-led Building Structural Audit in Chennai services in Chennai. Evidence-backed, report-based assessment by engineers in our network.",
  ...
  },
  {
    ...
    metaDescription: "Buildogram provides engineer-led Commercial Building Structural Audit in Chennai services in Chennai. Evidence-backed, report-based assessment by engineers in our network.",
  ...
  },
  {
    ...
    metaDescription: "Structural health checks for buildings over 20 years old in Chennai. We test load-bearing capacity before you renovate, buy, or add a new floor.",
  ...
  },
  {
    ...
    metaDescription: "Buildogram provides engineer-led Residential Structural Audit in Chennai services in Chennai. Evidence-backed, report-based assessment by engineers in our network.",
  ...
  },
  {
    ...
    metaDescription: "Building crack inspection in Chennai, coordinated with structural engineering professionals. We analyze wall and column cracks, identify the root cause (settlement, thermal, corrosion), and provide repair solutions.",
  ...
  },
  {
    ...
    metaDescription: "Hire experienced land surveyors in Chennai for accurate boundary marking, FMB sketch matching, and topographic surveys. Advanced DGPS and Total Station equipment used.",
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Do I need police permission to fly?", answer: "Drone flights in certain \"Red Zones\" in Chennai (near the airport, military bases, or port) are strictly restricted. Where applicable, the appointed drone operator is responsible for obtaining required permissions and meeting applicable regulatory requirements, including Digital Sky portal clearances." },
    ],
    stats: [],
    ctaHref: "/contact?type=survey",
  ...
  },
  {
    ...
    metaDescription: "Initial and Routine Pile Load Testing in Chennai. Prove the ultimate bearing capacity of your foundation piles with instrumented kentledge static load testing.",
  ...
  },
  {
    ...
    metaDescription: "Expert NDT testing for buildings and concrete structures in Chennai. Rebound hammer, UPV, rebar scanning, core extraction and half-cell potential testing coordinated with testing professionals.",
  ...
  },
  {
    ...
    metaDescription: "Rebound Hammer testing services in Chennai. Instantly measure the compressive strength of existing concrete columns, beams, and slabs without core cutting.",
