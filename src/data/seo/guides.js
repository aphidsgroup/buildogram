...
export const guides = [
  {
    ...
    relatedServices: ['/boq-audit', '/boq-review-chennai', '/services/construction-consultation'],
...

  {
    ...
    relatedServices: ['/boq-audit', '/boq-review-chennai'],
...

  {
    ...
    relatedServices: ['/cost-estimator', '/boq-audit', '/home-construction-chennai'],
...

  {
    ...
    relatedServices: ['/home-construction-chennai', '/boq-audit', '/property-passport'],
    relatedGuides: ['what-is-boq-in-construction', 'boq-checklist-for-homeowners'],
...

  {
    ...
    relatedServices: ['/property-passport', '/properties', '/renovation-contractors-chennai'],
...

  {
    ...
    relatedServices: ['/plan-review', '/structural-plan-review-chennai'],
...

  {
    ...
    relatedServices: ['/property-passport', '/quality-inspection-chennai'],
